...
namespace DAL.UserCenter.Entities
{
    ...
    public partial class PermissionPermissiongroup : BaseEntity
    {
        ...
        /// Nullable:True
        /// </summary>
        [SugarColumn(ColumnName = "permissiongroup_id", ColumnDescription = "权限组主键", IsNullable = true, Length = 36, ColumnDataType = "varchar", DecimalDigits = 0)]
