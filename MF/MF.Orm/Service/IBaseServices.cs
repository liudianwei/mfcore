...
namespace MF.Orm.Service
{
    public interface IBaseServices<T> : IDependency where T : class, new()
    {
        ...
        bool Update(T entity, List<string> list, bool isNull = true);
        ...
        bool Delete<PkType>(string[] primaryKeyValues);
        ...
        List<T> QueryableToList(Expression<Func<T, bool>> expression, Expression<Func<T, object>> orderFiled, OrderByType type = OrderByType.Asc);
