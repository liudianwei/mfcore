...
namespace Monitor
{
    ...
    /// 增加TagKey
    /// </summary>
    public class CircleMultStatusRotation : System.Windows.Forms.Control
    {
        /// <summary>
        /// =true,调Gif;false不调Gif
        /// </summary>
        ...
        /// <summary>
        ///  IsRotation =0不调用Gif；=1调用Gif TagValueType
        /// </summary>
        private int isRotation = 0;

        /// <summary>
        ///  IsRotation =0不调用Gif；=1调用Gif
        /// </summary>
        [
        Description("是否调用Gif"),
        ]
        ...
        ///
        /// </summary>
        public CircleMultStatusRotation()
            : base()
        {
            ...
            //旋转的Gif
            animatedImage = Properties.Resources.Animator;
            switch (IsRotation)
            {
                case 0:
        ...
        private void tagDataCartColorMultStatus_TagDataOnChange(object sender, CustomeEvetnArgs e)
        {
            if (OpName == e.OpName.ToString() & TagKey == e.TagID.ToString())
            {
                ...
                isRotation = Convert.ToInt32(e.TagTypeID);
                switch (colorsBackGroudColorTagValue)
                {
                    case 1:
                        this.BackColor = colorsBackGroudColorSet0;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                case 0:
                    OnPaint_DrawItem_0(e);
                    break;

                case 1:
                    OnPaint_DrawItem_1(e);
                    break;
            }
        }
        ...
        /// </summary>
        /// <param name="e"></param>
        private void OnPaint_DrawItem_0(PaintEventArgs e)
        {
        ...
        private void AnimateImage(PaintEventArgs e)
        {
            //Begin the animation.
            ...
            e.Graphics.DrawImage(this.animatedImage, 0, 0, this.Size.Width, this.Size.Height);
        }
        ...
        /// </summary>
        /// <param name="e"></param>
        private void OnPaint_DrawItem_1(PaintEventArgs e)
        {
            AnimateImage(e);
            Pen pen = new Pen(lineColor, 3);
            GraphicsPath path = new GraphicsPath();
