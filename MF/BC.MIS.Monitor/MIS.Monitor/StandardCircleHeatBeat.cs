...
namespace Monitor
{
    ...
    ///  Tag位置1时颜色
    /// </summary>
	public class StandardCircleHeatBeat : System.Windows.Forms.Control

    {
        ...
        ///
        /// </summary>
        public StandardCircleHeatBeat()
            : base()
        {
            SetStyle(ControlStyles.ResizeRedraw, true);
            SetStyle(ControlStyles.DoubleBuffer | ControlStyles.OptimizedDoubleBuffer | ControlStyles.AllPaintingInWmPaint, true);

            //GlobleData.tagDataHeartBeat.TagDataOnChange += new DelegateClassHandle(TagDataOnChange);
        }
        ...
        /// </summary>
        /// <param name="e"></param>
        public void StandardCircleHeatBeat_Show(CustomeEvetnArgs e)
        {
            try
            {
                colorsBackGroudColorTagValue = Convert.ToInt32(e.TagValue);
