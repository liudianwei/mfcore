...
namespace Monitor
{
    ...
    /// 垂直方式显示工件编号。
    /// </summary>
    public class ButtonEngineNumberColor : System.Windows.Forms.Button
    {
        ...
        ///
        /// </summary>
        public ButtonEngineNumberColor()
        {
        ...
        /// </summary>
        /// <param name="e"></param>
        public void ButtonEngineNumberColor_Show(CustomeEvetnArgs e)
        {
            engineNumber = Convert.ToString(e.TagValue);
            msToolTip = msToolTipHead + engineNumber;
        }
