...
namespace Monitor
{
    ...
    /// 增加TagKey
    /// </summary>
    public class StandardCircleCartColor : System.Windows.Forms.Control
    {
        /// <summary>
        /// TagKey 显示选项
        /// </summary>
        ...
        ///
        /// </summary>
        public StandardCircleCartColor()
            : base()
        {
            SetStyle(ControlStyles.ResizeRedraw, true);
            SetStyle(ControlStyles.DoubleBuffer | ControlStyles.OptimizedDoubleBuffer | ControlStyles.AllPaintingInWmPaint, true);

            //GlobleData.tagDataCartColor.TagDataOnChange += new DelegateClassHandle(TagDataOnChange);
        }
        ...
        /// </summary>
        /// <param name="e"></param>
        public void StandardCircleCartColor_Show(CustomeEvetnArgs e)
        {
