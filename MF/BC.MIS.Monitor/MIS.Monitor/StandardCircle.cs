...
namespace Monitor
{
    ...
    ///  Tag位置1时颜色
    /// </summary>
	public class StandardCircle : System.Windows.Forms.Control

    {
        ...
        ///
        /// </summary>
		public StandardCircle() : base()
        {
            SetStyle(ControlStyles.ResizeRedraw, true);
            SetStyle(ControlStyles.DoubleBuffer | ControlStyles.OptimizedDoubleBuffer | ControlStyles.AllPaintingInWmPaint, true);

            //GlobleData.tagDataMachine.TagDataOnChange += new DelegateClassHandle(TagDataOnChange);
        }
        ...
        /// </summary>
        /// <param name="e"></param>
        public void StandardCircle_Show(CustomeEvetnArgs e)
        {
            colorsBackGroudColorTagValue = Convert.ToInt32(e.TagValue);
            if ((colorsBackGroudColorTagValue & (int)Math.Pow(2, colorsBackGroudColorTagBit)) > 0)
                this.BackColor = colorsBackGroudColorSet;
