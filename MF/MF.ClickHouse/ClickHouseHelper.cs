...
namespace MF.ClickHouse
{
    public class ClickHouseHelper : IDisposable
    {
        ...
        public int ExecuteNoQuery(string sql, CommandType commandType, params ClickHouseDbParameter[] parameters)
        {
            try
            {
        ...
        public int ExecuteNoQuery(string sql, params ClickHouseDbParameter[] parameters)
        {
            try
            {
                return ExecuteNoQuery(sql, CommandType.Text, parameters);
            }
            catch (Exception e)
            {
                this.Dispose();
        ...
        public T ExecuteScalar<T>(string sql, CommandType commandType, params ClickHouseDbParameter[] parameters)
        {
            T result;
            try
            {
        ...
        public T ExecuteScalar<T>(string sql, params ClickHouseDbParameter[] parameters)
        {
            T result;
            try
            {
        ...
        public IDataReader ExecuteReader(string sql, CommandType commandType, params ClickHouseDbParameter[] parameters)
        {
        ...
        public IDataReader ExecuteReader(string sql, params ClickHouseDbParameter[] parameters)
        {
            IDataReader result;
            try
            {
        ...
        //public static List<T> ReaderToList<T>(Task<DbDataReader> dataReader)
        //{
        ...
        /// <returns></returns>
        public DataTable ExecuteDataTable(string sql, CommandType commandType, params ClickHouseDbParameter[] parameters)
        {
        ...
        /// <param name="parameters">sql参数</param>
        /// <returns></returns>
        public DataTable ExecuteDataTable(string sql, params ClickHouseDbParameter[] parameters)
        {
            DataTable result;
            try
            {
        ...
        /// <param name="parameters">sql参数</param>
        /// <returns></returns>
        public List<T> ExecuteList<T>(string sql, CommandType commandType, params ClickHouseDbParameter[] parameters) where T : class
        {
        ...
        /// <param name="parameters">sql参数</param>
        /// <returns></returns>
        public List<T> ExecuteList<T>(string sql, params ClickHouseDbParameter[] parameters) where T : class
        {
            List<T> resultList = new List<T>();
            try
            {
        ...
        public (ulong, DataTable) ExecuteDataTableByPagination(string sql, int pageindex, int pagesize, params ClickHouseDbParameter[] parameters)
        {
            DataTable result;
            ulong totalCount = 0;
            try
        ...
        /// <param name="parameters">sql参数</param>
        /// <returns>返回总条数和分页后数据</returns>
        public (ulong, List<T>) ExecuteListByPagination<T>(string sql, int pageindex, int pagesize, params ClickHouseDbParameter[] parameters) where T : class
        {
            List<T> result;
            ulong totalCount = 0;
            try
        ...
        private void AttachParameters(DbParameterCollection parametersCollection, ClickHouseDbParameter[] parameters)
        {
