...
namespace Common.Utils.MacroInfoLogger
{
    ...
    public interface ILogNet : IDisposable
    {
        ...
        void RecordMessage(HslMessageDegree degree, string keyWord, string text, string filename);
        ...
        void WriteDebug(string text, string filename);
        ...
        /// <param name="text"></param>
        /// <param name="filename"></param>
        void WriteDebug(string keyWord, string text, string filename);
        ...
        /// <param name="text"></param>
        /// <param name="filename"></param>
        void WriteError(string text, string filename);
        ...
        /// <param name="text"></param>
        /// <param name="filename"></param>
        void WriteError(string keyWord, string text, string filename);
        ...
        /// <param name="ex"></param>
        /// <param name="filename"></param>
        void WriteException(string keyWord, Exception ex, string filename);
        ...
        /// <param name="ex"></param>
        /// <param name="filename"></param>
        void WriteException(string keyWord, string text, Exception ex, string filename);
        ...
        /// <param name="text"></param>
        /// <param name="filename"></param>
        void WriteFatal(string text, string filename);
        ...
        /// <param name="text"></param>
        /// <param name="filename"></param>
        void WriteInfo(string text, string filename);
        ...
        /// <param name="text"></param>
        /// <param name="filename"></param>
        void WriteInfo(string keyWord, string text, string filename);
        ...
        /// <param name="text"></param>
        /// <param name="filename"></param>
        void WriteWarn(string text, string filename);
        ...
        /// <param name="text"></param>
        /// <param name="filename"></param>
        void WriteWarn(string keyWord, string text, string filename);
