...
namespace HslCommunication.LogNet
{
    ...
    public abstract class LogNetBase : IDisposable
    {
        ...
        public void WriteDebug(string text, string filename)
        {
            WriteDebug(string.Empty, text, filename);
        }
        ...
        /// <param name="text">文本内容</param>
        /// <param name="filename">写入文件名</param>
        public void WriteDebug(string keyWord, string text, string filename)
        {
            RecordMessage(HslMessageDegree.DEBUG, keyWord, text, filename);
        }
        ...
        /// <param name="text">文本内容</param>
        /// <param name="filename">写入文件名</param>
        public void WriteInfo(string text, string filename)
        {
            WriteInfo(string.Empty, text, filename);
        }
        ...
        /// <param name="text">文本内容</param>
        /// <param name="filename">写入文件名</param>
        public void WriteInfo(string keyWord, string text, string filename)
        {
            RecordMessage(HslMessageDegree.INFO, keyWord, text, filename);
        }
        ...
        /// <param name="text">文本内容</param>
        /// <param name="filename">写入文件名</param>
        public void WriteWarn(string text, string filename)
        {
            WriteWarn(string.Empty, text, filename);
        }
        ...
        /// <param name="text">文本内容</param>
        /// <param name="filename">写入文件名</param>
        public void WriteWarn(string keyWord, string text, string filename)
        {
            RecordMessage(HslMessageDegree.WARN, keyWord, text, filename);
        }
        ...
        /// <param name="text">文本内容</param>
        /// <param name="filename">写入文件名</param>
        public void WriteError(string text, string filename)
        {
            WriteError(string.Empty, text, filename);
        }
        ...
        /// <param name="text">文本内容</param>
        /// <param name="filename">写入文件名</param>
        public void WriteError(string keyWord, string text, string filename)
        {
            RecordMessage(HslMessageDegree.ERROR, keyWord, text, filename);
        }
        ...
        /// <param name="text">文本内容</param>
        /// <param name="filename">写入文件名</param>
        public void WriteFatal(string text, string filename)
        {
            WriteFatal(string.Empty, text, filename);
        }
        ...
        /// <param name="ex"></param>
        /// <param name="filename">写入文件名</param>
        public void WriteException(string keyWord, Exception ex, string filename)
        {
            WriteException(keyWord, string.Empty, ex, filename);
        }
        ...
        public void RecordMessage(HslMessageDegree degree, string keyWord, string text, string filename)
        {
            WriteToFile(degree, keyWord, text, filename);
        }
        ...
        #endregion Filtrate Keyword

        #region File Write

        private void WriteToFile(HslMessageDegree degree, string keyWord, string text, string filename)
        {
            // 过滤事件
            if (degree <= m_messageDegree)
            {
                // 需要记录数据
                HslMessageItem item = GetHslMessageItem(degree, keyWord, text, filename);
                AddItemToCache(item);
            }
        }
        ...
        private void ThreadPoolSaveFile(object obj)
        {
            ...
            if (!string.IsNullOrEmpty(LogSaveFileName))
            {
                ...
                {
                    foreach (var item in swmsp.Values)
                    {
                        item.Close();
                        item?.Dispose();
                    }
        ...
        protected static string CheckPathEndWithSprit(string filePath)
        {
        ...
        /// <param name="filename"></param>
        /// <returns></returns>
        private static HslMessageItem GetHslMessageItem(HslMessageDegree degree, string keyWord, string text, string filename)
        {
        ...
        /// <returns></returns>
        private static int CalculateStringOccupyLength(string str)
        {
        ...
        private static void AppendCharToStringBuilder(StringBuilder sb, char c, int count)
        {
        ...
        ///
        /// </summary>
        protected int m_CurrentFileSize;
