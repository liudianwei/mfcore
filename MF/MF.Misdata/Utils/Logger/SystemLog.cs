...
namespace Common.Utils
{
    ...
    public class SystemLog
    {
        ...
        /// </summary>
        /// <returns></returns>
        private static readonly ILogNet _logger = new LogNetDateTime(ConfigHelper.GetAppseting("Logger:DirPath"), ConfigHelper.GetAppseting("Logger:SystemName"), GenerateMode.ByEveryDay);
        ...
        /// <param name="e"></param>
        /// <param name="filename">默认common</param>
