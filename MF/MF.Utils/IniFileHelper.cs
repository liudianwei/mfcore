...
namespace MF.Utils
{
    public class IniFileHelper
    {
        ...
        public bool GetIniString(string section, string key, string strDefault, StringBuilder retVal)
        {
            long liRet = GetPrivateProfileString(section, key, strDefault, retVal, retVal.Capacity, strIniFilePath);
            return (liRet >= 1);
        }
