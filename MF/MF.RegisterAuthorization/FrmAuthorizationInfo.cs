...
namespace GetAuthorization
{
    public partial class FrmAuthorizationInfo : Form
    {
        ...
        private void Button_upload_Click(object sender, EventArgs e)
        {
            ...
            File.Copy(filepath, $"{Environment.CurrentDirectory}\\license.lic", true);
        ...
        {
            var res = LicenseHelper.Check(MachineCode, label_Product.Text, out string msg, out var info);
            if (res)
            {
                ...
                button_close.Location = new Point(691, 623);
            ...
            else
            {
                ...
                button_upload.Location = new Point(582, 623);
                button_close.Location = new Point(691, 623);
            }
        }
    }
