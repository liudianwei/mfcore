...
namespace MF.Core.Extensions
{
    ...
    public static class TypeExt
    {
        ...
        public static long[] ToInt64Arr(this string[] arr)
        {
            return Array.ConvertAll(arr, c => c.ToInt64());
        }

        public static int[] ToInt32Arr(this string[] arr)
        {
            return Array.ConvertAll(arr, c => c.ToInt32());
        }

        public static string[] ToStringArr(this long[] arr)
        {
            return Array.ConvertAll(arr, c => c.ToString());
        }
